...
/*=============== WORK MODAL ===============*/
    ...
    const workModalBtns = document.querySelectorAll(".work__details-button");
    const workModalClose = document.querySelectorAll(".work__modal-close");

    let workModalFunction = function (modalClick) {
        workModalViews[modalClick].classList.add("active-modal");
    };

    workModalBtns.forEach((wmb, i) => {
        wmb.addEventListener("click", () => {
            workModalFunction(i);
        });
    });

    workModalClose.forEach((wmc) => {
        wmc.addEventListener("click", () => {
            workModalViews.forEach((wmv) => {
                wmv.classList.remove("active-modal");
            });
        });
    });
